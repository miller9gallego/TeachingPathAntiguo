import { Avatar, Dropdown, Modal, Portlet, RichList, Row, Widget10, Widget8, } from "@panely/components";
                                                    ...
                                                    swal
                                                        ...
                                                        .then((result) => {
                                                            if (result.value) {
                                                                ...
                                                                fetch(url).then((res) => {
                                                                    swal.fire({
                                                                        text: "Se envio un correo con el reporte a todos los inscriptos al form.",
                                                                        icon: "info",
                                                                    });
                                                                });
                                                            }
                                                        ...
                                                        <RichList.Content>
                                                            <RichList.Title
                                                                onClick={() => {
                                                                    ...
                                                                    window.open(`${url}pathway/resume?id=${id}`, '_blank');
                                                                }}
                                                                children={
                                                                    <Progress
                                                                        striped
                                                            ...
                                                            <RichList.Title
                                                                children={user.email.substring(0, user.email.indexOf("@"))}
                                                                onClick={() => {
                                                                    const url = window.location.href.substring(0, window.location.href.indexOf('#'));
                                                                    window.open(`${url}pathway/resume?id=${id}`, '_blank');
                                                                }}
