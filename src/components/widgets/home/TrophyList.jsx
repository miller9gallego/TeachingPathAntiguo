...
import { getTrophiesByUser } from "consumer/journey/journey";
...
class TrophtyListComponent extends React.Component {
    ...
    render() {
        return (
            <Portlet className="my-4 rounded-bottom">
                <Portlet.Header>
                    <Portlet.Icon>
                ...
                <Portlet.Body className="list rounded-bottom">
                    <div className="mt-4 rounded-bottom">
