...
function* activitySaga({payload}) {
    ...
    switch (payload.type) {
        case "start_pathway":
            ...
            yield put(pageShowAlert("Excelente! obtuviste +" + point + " puntos por iniciar el form"))
            break;
        case "complete_track":
        ...
        case "complete_pathway":
            ...
            addPoint(user, point);
            yield put(userChange({...dataUser, point: dataUser.point + point,}));
            yield put(pageShowAlert("¡Felicidades! obtuviste +" + point + " puntos por completar el form"))
            break;
